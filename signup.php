            ...
            <div class="row">
                ...
                <form class="col-md-8 mx-auto" action="home.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input name="firstname" class="form-control" type="text" placeholder="Enter First Name">
                    </div>

                    <div class="form-group">
                        <label for="lastname"></label>
                        <label>Last Name:</label>
                        <input name="lastname" class="form-control" type="text" placeholder="Enter Last Name">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input name="orgid" class="form-control" type="text" placeholder="Enter Organization ID">
                    </div>

                    <div class="form-group">
                        <label for="ssn"></label>
                        <label>Social Security Number (SSN):</label>
                        <input name="password" class="form-control"  type="password" placeholder="Enter SSN in form XXX-XXX-XXXX">
                        <!-- <small class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input name="password" class="form-control"  type="text" placeholder="Enter Address">
                        <!-- <small class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                    </div>
