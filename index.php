            ...
            <div class="mx-auto heading-line"></div>
                ...
                <div class="row">
                    <div class="col-md-4 text-center">
                        ...
                        <h4 class="animated slideInLeft delay-1s py-3">Web Access</h4>
                        <p class="animated slideInLeft delay-1s pb-5">
                            Easily accessible analytics <br>
                            business to improve your trading performance!</p>
                    </div>
                    <div class="col-md-4 text-center">
                        <i class="fa fa-bar-chart"></i>
                        <h4 class="animated slideInLeft delay-1s py-3">Data Analytics</h4>
                        <p class="animated slideInLeft delay-1s pb-5">
                            Analyze trading performance and pin-point <br>
                            areas of improvement.</p>
                    </div>
                    <div class="col-md-4 text-center">
                        <i class="fa fa-code"></i>
                        <h4 class="animated slideInLeft delay-1s py-3">Automation</h4>
                        <p class="animated slideInLeft delay-1s pb-5">
                            Pinpoint weaknesses with our superior analysis<./p>
                    </div>
                </div>
    </section>
